...
# remotes::install_github("PIP-Technical-Team/wbpip@dev_stage2", dependencies = FALSE)
...
# Note: If cache is loaded as a list, we need as a table:
...
list(
  ...
  # tar_target(
  #   cache_mi,
  #   get_cache_mi(cache = cache)
  # ),
  # 
  
  # 
  # ### Cache for group and aggregated data
  # tar_target(
  #   cache_ga,
  #   get_cache_ga(cache = cache)
  # ),
  ...
  ### Reference Year estimations tables ----
  ...
  ### Survey Year estimations tables ----
